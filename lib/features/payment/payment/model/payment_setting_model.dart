class PaymentSettingModel {
  ...
  PaymentSettingModel.fromJson(Map<String, dynamic> json) {
    ...
    uPayments = json['upayments'] != null
        ? UPaymentsModel.fromJson(json['upayments'])
        : null;
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (uPayments != null) {
      data['upayments'] = uPayments!.toJson();
    }
    return data;
  }
}
...
class UPaymentsModel {
  ...
  UPaymentsModel.fromJson(Map<String, dynamic> json) {
    ...
    isSandboxEnabled = json['is_sandbox_enabled'];
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    data['is_sandbox_enabled'] = isSandboxEnabled;
    return data;
  }
}

class UPaymentsResponse {
  final bool success;
  ...
  factory UPaymentsResponse.fromJson(Map<String, dynamic> json) {
    return UPaymentsResponse(
