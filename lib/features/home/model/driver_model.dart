class DriverModel {
  ...
  String? error;
  String? message;
  String? reason; // Specific error reason for debugging
  Map<String, dynamic>? debug; // Debug info from backend
  ...
  DriverModel.fromJson(Map<String, dynamic> json) {
    ...
    reason = json['reason'];
    debug =
        json['debug'] != null ? Map<String, dynamic>.from(json['debug']) : null;
    if (json['data'] != null) {
      data = <DriverData>[];
      json['data'].forEach((v) {
